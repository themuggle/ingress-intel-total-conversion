...
// @name           IITC Plugin: Player tracker with Level-Markers
...
// Level
 ...
 //     title += ago(ev.time, now) + minsAgo + window.chat.getChatPortalName(ev) + ' ' + speed(ev, prevEv) + '\n'; 
    ...
    if(window.plugin.guessPlayerLevels !== undefined &&
       window.plugin.guessPlayerLevels.fetchLevelByPlayer !== undefined) {
    	window.iconEnl = L.Icon.Default.extend({options: { iconUrl: base + '/marker-green_' + playerLevel + '.png'} });
        window.iconRes = L.Icon.Default.extend({options: { iconUrl: base + '/marker-blue_' + playerLevel + '.png'} }); }
    else {
    	window.iconEnl = L.Icon.Default.extend({options: { iconUrl: base + '/marker-green_' + players[playerData.nick] + '.png'} });
        window.iconRes = L.Icon.Default.extend({options: { iconUrl: base + '/marker-blue_' + players[playerData.nick] + '.png'} });
    }
